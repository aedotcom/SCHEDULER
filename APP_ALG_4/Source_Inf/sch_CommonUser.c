...
BOOL _SCH_COMMON_CONFIG_INITIALIZE( int runalg , int subalg , int guialg , int maxpm ) {
	return _SCH_COMMON_CONFIG_INITIALIZE_STYLE_4( runalg , subalg , guialg , maxpm );
}
//===========================================================================================================
...
int _SCH_COMMON_RECIPE_ANALYSIS_BM_USEFLAG_SETTING( int CHECKING_SIDE , int lc_target_wafer_count , char *errorstring , int *TMATM ) {
	return _SCH_COMMON_RECIPE_ANALYSIS_BM_USEFLAG_SETTING_STYLE_4( CHECKING_SIDE , lc_target_wafer_count , errorstring , TMATM );
}
//===========================================================================================================
...
BOOL _SCH_COMMON_READING_CONFIG_FILE_WHEN_CHANGE_ALG( int chg_ALG_DATA_RUN ) {
	return _SCH_COMMON_READING_CONFIG_FILE_WHEN_CHANGE_ALG_STYLE_4( chg_ALG_DATA_RUN );
}
//===========================================================================================================
BOOL _SCH_COMMON_PRE_PART_OPERATION( int CHECKING_SIDE , int mode , int *dataflag , int *dataflag2 , int *dataflag3 , char *errorstring ) {
	return _SCH_COMMON_PRE_PART_OPERATION_STYLE_4( CHECKING_SIDE , mode , dataflag , dataflag2 , dataflag3 , errorstring );
}
//===========================================================================================================
BOOL _SCH_COMMON_RUN_MFIC_COMPLETE_MACHINE( int side , int WaitParam , int option ) {
	return _SCH_COMMON_RUN_MFIC_COMPLETE_MACHINE_STYLE_4( side , WaitParam , option );
}
//===========================================================================================================
//===========================================================================================================
//===========================================================================================================
...
int _SCH_COMMON_EVENT_PRE_ANALYSIS( char *FullMessage , char *RunMessage , char *ElseMessage , char *ErrorMessage ) {
	return _SCH_COMMON_EVENT_PRE_ANALYSIS_STYLE_4( FullMessage , RunMessage , ElseMessage , ErrorMessage );
}
//===============================================================================
int _SCH_COMMON_EVENT_ANALYSIS( char *FullMessage , char *RunMessage , char *ElseMessage , char *ErrorMessage ) {
	return _SCH_COMMON_EVENT_ANALYSIS_STYLE_4( FullMessage , RunMessage , ElseMessage , ErrorMessage );
}
//===============================================================================
...
BOOL _SCH_COMMON_FINISHED_CHECK( int side ) {
	return _SCH_COMMON_FINISHED_CHECK_STYLE_4( side );
}
//===========================================================================================================
BOOL _SCH_COMMON_CASSETTE_CHECK_INVALID_INFO( int mode , int side , int ch1 , int ch2 , int option ) {
	return _SCH_COMMON_CASSETTE_CHECK_INVALID_INFO_STYLE_4( mode , side , ch1 , ch2 , option );
}
//===========================================================================================================
BOOL _SCH_COMMON_GET_PROCESS_FILENAME( char *logpath , char *lotdir , BOOL prcs , int ch , int side , int waferindex1 , int waferindex2 , int waferindex3 , char *filename , BOOL dummy , int mode , BOOL notuse , BOOL highappend ) {
	return _SCH_COMMON_GET_PROCESS_FILENAME_STYLE_4( logpath , lotdir , prcs , ch , side , waferindex1 , waferindex2 , waferindex3 , filename , dummy , mode , notuse , highappend );
}
//===========================================================================================================
...
BOOL _SCH_COMMON_SIDE_SUPPLY( int side , BOOL EndCheck , int Supply_Style , int *Result ) {
	return _SCH_COMMON_SIDE_SUPPLY_STYLE_4( side , EndCheck , Supply_Style , Result );
}
//===========================================================================================================
BOOL _SCH_COMMON_FM_ARM_APLUSB_SWAPPING() {
	return _SCH_COMMON_FM_ARM_APLUSB_SWAPPING_STYLE_4();
}
//===========================================================================================================
BOOL _SCH_COMMON_PM_MULTI_ENABLE_DISABLE_CONTROL() {
	return _SCH_COMMON_PM_MULTI_ENABLE_DISABLE_CONTROL_STYLE_4();
}
//===========================================================================================================
BOOL _SCH_COMMON_PM_MULTI_ENABLE_SKIP_CONTROL( int side , int pt , int ch ) {
	return _SCH_COMMON_PM_MULTI_ENABLE_SKIP_CONTROL_STYLE_4( side , pt , ch );
}
//===========================================================================================================
int _SCH_COMMON_PM_2MODULE_SAME_BODY() { // 2007.10.07
	return _SCH_COMMON_PM_2MODULE_SAME_BODY_STYLE_4();
}
//===========================================================================================================
int _SCH_COMMON_BM_2MODULE_SAME_BODY() {
	return _SCH_COMMON_BM_2MODULE_SAME_BODY_STYLE_4();
}
//===========================================================================================================
...
int  _SCH_COMMON_CHECK_PICK_FROM_FM( int side , int pt , int subchk ) {
	return _SCH_COMMON_CHECK_PICK_FROM_FM_STYLE_4( side , pt , subchk );
}
//===========================================================================================================
BOOL _SCH_COMMON_CHECK_END_PART( int side , int mode ) {
	return _SCH_COMMON_CHECK_END_PART_STYLE_4( side , mode );
}
//===========================================================================================================
...
BOOL _SCH_COMMON_EXTEND_FM_ARM_CROSS_FIXED( int side ) {
	return _SCH_COMMON_EXTEND_FM_ARM_CROSS_FIXED_STYLE_4( side );
}
//===========================================================================================================
int  _SCH_COMMON_CHECK_WAITING_MODE( int side , int *mode , int lc_precheck , int option ) {
	return _SCH_COMMON_CHECK_WAITING_MODE_STYLE_4( side , mode , lc_precheck , option );
}
//===========================================================================================================
BOOL _SCH_COMMON_TUNING_GET_MORE_APPEND_DATA( int mode , int ch , int curorder , int pjindex , int pjno ,
						...
						int TuneData_Index ,
						char *AppendStr ) {
	return _SCH_COMMON_TUNING_GET_MORE_APPEND_DATA_STYLE_4( mode , ch , curorder , pjindex , pjno ,
						TuneData_Module ,
						TuneData_Order ,
						TuneData_Step ,
						TuneData_Name ,
