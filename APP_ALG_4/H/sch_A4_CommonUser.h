#ifndef SCH_A4_COMMONUSER_H
#define SCH_A4_COMMONUSER_H
...
BOOL _SCH_COMMON_CASSETTE_CHECK_INVALID_INFO_STYLE_4( int mode , int side , int cm1 , int cm2 , int option );
...
int  _SCH_COMMON_PM_2MODULE_SAME_BODY_STYLE_4();
