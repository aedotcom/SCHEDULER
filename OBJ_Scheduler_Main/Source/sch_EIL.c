...
<ERROR CODE>
	...
	INSERT
		...
		1 - BM ���� �߸��� ���Դϴ�.
		2 - BM Slot���� �߸��� ���Դϴ�.
		4 - SourceWafer ���� 1-MAX_CASSETTE_SLOT ���̰� �ƴմϴ�.
		5 - BM�� �ش� Slot�� Method�� �����մϴ�.

		11 - BM�� �������� �ʴ� BM�Դϴ�.
		12 - BM�� Dummy/Align�� BM�Դϴ�.
		13 - BM�� Enable���°� �ƴմϴ�.
		14 - BM�� FM_SIDE���°� �ƴմϴ�.
		15 - BM�� FM_SIDE�� �������Դϴ�.

		21 - Source ������ ���� Wafer�� �̹� �����մϴ�.
		22 - �ش� Wafer�� inser�� ���� ���������� �����ϴ�.

		31 - Cluster Recipe File�� �д��߿� File�� ������ �ֽ��ϴ�.
		32 - Cluster Recipe File�� �д��߿� USER_RECIPE_CLUSTER_DATA_READ DLL�� ������ �ֽ��ϴ�.(FA Mode)
		33 - Cluster Recipe File�� �д��߿� DLL�� Data�� �����ϴµ� ������ �ֽ��ϴ�.(FA Mode)
		34 - Cluster Recipe File�� �д��߿� USER_RECIPE_CLUSTER_DATA_READ DLL�� ������ �ֽ��ϴ�.
		35 - Cluster Recipe File�� �д��߿� DLL�� Data�� �����ϴµ� ������ �ֽ��ϴ�.

		51 - Information File�� �д��߿� ������ �ֽ��ϴ�.
		61 - DLL Interface(Normal)�� ���� Data Setting�߿� ������ �ֽ��ϴ�.
		71 - DLL Interface(MFI)�� ���� Data Setting�߿� ������ �ֽ��ϴ�.
		81 - Lot Pre Fail
	...
	REMOVE
		...
		1 - BM ���� �߸��� ���Դϴ�.
		2 - BM Slot���� �߸��� ���Դϴ�.
		6 - BM�� �ش� Slot�� Method�� �������� �ʽ��ϴ�.
		7 - BM�� �ش� Method�� PathRange���� �߸��Ǿ����ϴ�.
	...
	BEGIN
		...
		1 - �ش� SIDE(CM)�� Running�� �ƴҶ�
		2 - �ش� SIDE(CM)�� Wafer�� ���� �̻��� �����߿� ������

		11 - MAIN_CONTROL IO�� ���°� CTC_IDLE(0)�� ��
		12 - MAIN_CONTROL IO�� ���°� CTC_IDLE(0)���� ������
		13 - MAIN_CONTROL IO�� ���°� CTC_DISABLE(5)�� ��
		14 - MAIN_CONTROL IO�� ���°� CTC_ABORTING(4)�� ��
		15 - MAIN_CONTROL IO�� ���°� CTC_WAIT_HAND_OFF(7)���� ũ�ų� ������
...
//_IO_COMMON_PRINTF( 3 , "EIL" , "INSERT" , "[B] RES=%d , BM=%d,Slot=%d,incm0=%d,Wafer=%d,File=%s\n" , Res , bm , slot , incm0 , wafer , clusterRecipefile );
	...
	//==========================================================================================
//	_i_SCH_CLUSTER_Set_PathStatus( side , pt , SCHEDULER_SUPPLY ); // 2011.07.05 // 2011.10.20 FM_Nomore�� ���� �ʰ� �ϱ� ���� READY�� ���ܵ�
	//-----------------------------------------------------------------------------------------------------------------------
